...
export default function Header() {
	return (
		<div className='flex flex-col justify-between items-center p-4 h-32 overflow-hidden bg-gradient-to-bl from-accent to-secondary to-30% text-secondary-content'>
