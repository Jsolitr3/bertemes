...
export default function Header() {
	...
	return (
		<div className='w-full relative z-0 flex flex-none flex-col justify-between items-center p-4 sm:h-28 h-24 overflow-hidden bg-secondary text-secondary-content'>
