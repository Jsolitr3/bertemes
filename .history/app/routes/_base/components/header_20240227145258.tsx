...
export default function Header() {
	return (
		<div className='flex flex-col justify-between items-center p-4 h-32 overflow-hidden bg-gradient-to-bl from-accent from-10% to-secondary text-secondary-content'>
