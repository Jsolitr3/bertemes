	...
	return (
		<div className='container mx-auto p-8 text-secondary-content'>
			...
			<Collapsible title='QuickBooks®' description='Unlock the Power of QuickBooks with Us!'>
				...
				{/* New Client Offering */}
				<div className='bg-base-100 text-secondary p-6 rounded-lg shadow-lg mb-8'>
				...
				<div className='bg-base-100 text-secondary p-6 rounded-lg shadow-lg drop-shadow-xl mb-8'>
