		...
		<div className='container mx-auto p-8 text-secondary-content'>
			...
			<Collapsible title='Compilation & Review' description='Confidence in Your Financial Statements.'>
				...
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl font-semibold mb-4'>Comprehensive Assurance Solutions</h2>
				...
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl font-semibold mb-4'>Beyond Financial Statements</h2>
					<p className='text-gray-700'>
				...
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl font-semibold mb-4'>Understanding the Difference</h2>
