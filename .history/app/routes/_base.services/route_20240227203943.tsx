		...
		<div className='container mx-auto p-8 text-secondary-content'>
			...
			<Collapsible title='Income Tax Advising & Compliance' description='Optimize Your Finances with Our Tax Services!'>
				...
				<div className='bg-base-100 p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-xl text-secondary font-semibold mb-4'>Expert Tax Preparation</h2>
					<p className='text-md'>
				...
				{/* Tax Planning */}
				<div className='bg-base-100 p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-xl text-secondary font-semibold mb-4'>Strategic Tax Planning</h2>
					<p className='text-md'>
				...
				<div className='bg-base-100 p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-xl text-secondary font-semibold mb-4'>Strong Representation</h2>
					<p className='text-md'>
				...
				{/* Sales Tax Service */}
				<div className='bg-base-100 p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-xl text-secondary font-semibold mb-4'>Effortless Sales Tax Management</h2>
					<p className='text-md'>
