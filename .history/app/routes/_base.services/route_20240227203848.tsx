		...
		<div className='container mx-auto p-8 text-secondary-content'>
			...
			<Collapsible title='Income Tax Advising & Compliance' description='Optimize Your Finances with Our Tax Services!'>
				...
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl text-secondary font-semibold mb-4'>Expert Tax Preparation</h2>
				...
				{/* Tax Planning */}
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl text-secondary font-semibold mb-4'>Strategic Tax Planning</h2>
					<p className='text-gray-700'>
				...
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl text-secondary font-semibold mb-4'>Strong Representation</h2>
					<p className='text-gray-700'>
				...
				{/* Sales Tax Service */}
				<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
					<h2 className='text-2xl text-secondary font-semibold mb-4'>Effortless Sales Tax Management</h2>
					<p className='text-gray-700'>
