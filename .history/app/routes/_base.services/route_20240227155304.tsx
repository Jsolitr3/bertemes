				...
				<div className='collapse-content'>
					...
					<div className='container mx-auto p-8'>
						...
						<p className='text-lg text-gray-700 mb-8'>
							As Certified Advanced QuickBooks ProAdvisors and Certified Public Accountants, we are your go-to experts
							for seamlessly navigating QuickBooks and tackling accounting challenges faced by small businesses.
						</p>
						...
						<div className='bg-white p-6 rounded-lg shadow-md mb-8'>
							...
							<p className='text-gray-700'>
								For new clients, we provide an initial troubleshooting and training session. Enjoy one-on-one training
								and consulting tailored to your unique needs.
							</p>
						</div>
