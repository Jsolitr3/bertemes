	...
	return (
		<div className='max-w-sm relative bg-white shadow-lg rounded-lg overflow-hidden'>
			...
			<div className='w-full h-full flex flex-col items-center justify-center'>
				...
				{/* Cool Initial */}
				<div className='absolute mask mask-hexagon top-0 left-0 w-16 h-16 flex items-center justify-center text-secondary-content font-bold text-2xl bg-gradient-to-tr from-secondary to-primary rounded-full'>
					{name.charAt(0)}
				</div>
