	...
	return (
		<div className='max-w-sm relative bg-base-100 shadow-lg rounded-lg overflow-hidden'>
			...
			<div className='w-full h-full flex flex-col items-center justify-center'>
				...
				{/* Name */}
				<div className='absolute rounded-lg p-2 bg-gradient-to-tr from-primary to-60% to-secondary top-0 left-0 text-secondary-content font-bold text-lg mb-4 ml-4'>
					{name}
				</div>
			</div>
