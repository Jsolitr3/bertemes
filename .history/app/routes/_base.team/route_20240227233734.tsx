		...
		<div className='flex flex-wrap justify-center gap-4 p-4'>
			...
			<TeamMemberCard name='Therese Johnson' primaryImage={ThereseJohnsonHeadshot}>
				<div className='flex flex-col gap-4'>
					<p>
						Therese Johnson, CPA, brings over 25 years of extensive experience in accounting and tax. Her diverse career
						spans the government, public, and private sectors of business.
					</p>
					<p>
						A proud member of the American Institute of Certified Public Accountants and the Ohio Society of Certified
						Public Accountants, Therese has been a licensed CPA in Ohio since 1993. She earned her Bachelor of Business
						Administration in Accounting from the University of Akron.
					</p>
					<p>
					...
					<p>
						Building long-term client relationships is Therese's dedication. She is proficient in client engagements and
						excels in problem-solving for small business needs. Therese began her career at the Ohio Department of
					...
					<p>
						After six years in public accounting, Therese spent nearly 20 years in the private sector. She also operated
						from a home office, providing accounting and financial services, and preparing tax returns for personal and
						corporate customers. Proficient in QuickBooks, Therese offers income tax preparation services and payroll
						solutions for individuals, partnerships, corporations, and not-for-profit organizations.
					</p>
					<p>
