...
export default function Route() {
	...
	return (
		<div className='flex flex-col w-full gap-8 items-center h-full py-8'>
			<div className='w-full max-w-4xl p-8 bg-base-100 rounded-lg drop-shadow-lg'>
			...
			<div className='w-full max-w-4xl p-8 bg-base-100 rounded-lg drop-shadow-lg text-secondary'>
