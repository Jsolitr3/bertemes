...
export default function Route() {
	...
	return (
		<div className='flex justify-center items-center h-full pt-20'>
			<div className='w-full max-w-md p-8 bg-base-100 rounded-md drop-shadow-lg'>
				...
				<button onClick={handleSubmit} className='w-full bg-primary text-primary-content p-2 rounded-md cursor-pointer'>
					Send Message
				</button>
			</div>
		</div>
