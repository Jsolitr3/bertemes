...
export default function Route() {
	return (
		<div className='container mx-auto p-8 text-secondary-content'>
			<h1 className='sm:text-4xl text-3xl font-bold mb-8 text-secondary'>Our Team</h1>
			<div className='flex flex-wrap justify-center items-center gap-4 p-4'>
				...
				<TeamMemberCard name='Therese Johnson, CPA' primaryImage={ThereseJohnsonHeadshot}>
					<div className='flex flex-col items-center gap-4'>
						<p>
